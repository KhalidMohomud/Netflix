  ...
  return (
    <div className="relative flex h-screen w-screen flex-col md:items-center md:justify-center">
      <img
        ...
        alt=""
        className="absolute h-screen w-full object-cover -z-10 !hidden opacity-60 sm:!inline"
      />
      ...
      >
        ...
        <label className="inline-block w-full">
          ...
          />
          {errors.email && <p className="pt-2 text-sm text-orange-500">Please enter a valid email</p>}
        </label>
        ...
        <label className="inline-block w-full">
          <input
            ...
            className="form-control"
          />
          {errors.password && <p className="pt-2 text-sm text-orange-500">Please enter a valid password</p>}
        </label>
        ...
        <div className="flex flex-row space-x-2 my-4">
          ...
          <Link className="hover:underline" to="/Login">Sign up now</Link>
        </div>
      </form>
    </div>
  );
